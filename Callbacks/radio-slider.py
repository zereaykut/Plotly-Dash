...
app.layout = html.Div(
    [
        dcc.RadioItems(
            options=["car", "house", "ship"], value="ship", id="my-radio-btn"
        ),
...
def update_text(
    selected_text, selected_font_size
    ...
    return f"The Radio Button value you chose was: {selected_text}", {
        "fontSize": selected_font_size
    }  # the returned objects are assigned to the component properties of the Outputs
