    ...
    [
        dbc.CardBody(
            [
                ...
                dbc.CardImg(
                    src="/assets/berlinwall.jpg", title="Graffiti by Gabriel Heimler"
                ),
...
graph_card = dbc.Card(
    [
        dbc.CardBody(
            [
                html.H4(
                    "Graffiti in Berlin 2012-2019",
                    className="card-title",
                    style={"text-align": "center"},
                ),
                dbc.Button("About Berlin", id="popover-bottom-target", color="info"),
                dbc.Popover(
                    [
...
app.layout = html.Div(
    [
        dbc.Row(
            [dbc.Col(image_card, width=3), dbc.Col(graph_card, width=8)],
            justify="around",
        )
    ]
)
